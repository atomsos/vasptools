...
from atomse import __version__
from atomse.utils import import_module
program = 'atomse'
...
# python -m atomse.cli.completion to update autocompletion.
commands = [
    ('run', program+'.cli.run'),
...
def main(prog=program, description='ASE command line tool.',
